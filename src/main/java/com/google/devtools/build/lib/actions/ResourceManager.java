...
public class ResourceManager {
    ...
    for (Map.Entry<String,String> keyValue : mnemonic_resource_override){
      ...
      try {
        ...
        throw new OptionsParsingException(
                "mnemonic_resource_override does not have 2 integer values.", e);
      }
    }
   ...
   */
  public ResourceHandle acquireResources(ActionExecutionMetadata owner, String mnemonic, ResourceSet resources)
